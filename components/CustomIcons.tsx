...
export const FireIcon = ({ className }: { className?: string }) => (
  <svg viewBox="0 0 24 24" fill="currentColor" className={className}>
    <path d="M12 22c4.97 0 9-4.03 9-9-4.5 0-4.5-5-9-9-4.5 4-4.5 9-9 9 0 4.97 4.03 9 9 9z" opacity="0.4"/>
    <path d="M12 22c3.87 0 7-3.13 7-7-3.5 0-3.5-4-7-7-3.5 3-3.5 7-7 7 0 3.87 3.13 7 7 7z" />
  </svg>
);
